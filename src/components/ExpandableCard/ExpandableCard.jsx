                ...
                {active && typeof active === 'object' ? (
                    <div className="fixed inset-0 z-[100] grid place-items-center">
                        ...
                        <motion.div
                            ...
                            ref={ref}
                            className="custom-scrollbar flex h-full w-full max-w-[500px] flex-col overflow-y-auto bg-white sm:rounded-3xl md:h-fit md:max-h-[90%] dark:bg-neutral-900"
                        >
                            {/*Poster*/}
        ...
        content: () => {
            return (
                <p>
                    ...
                    become a cultural icon in the heavy metal music industry. <br /> <br />
                    Their songs often reflect themes of aggression, social issues, and personal struggles, capturing the
                    essence of the heavy metal genre. With a career spanning over four decades, Metallica has released
                    numerous hit albums and singles that have garnered them a massive fan following both in the United
                    States and abroad.
                </p>
            );
        },
