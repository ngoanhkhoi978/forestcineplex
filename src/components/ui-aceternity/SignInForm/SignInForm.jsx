...
export default function SignInForm({ className }) {
    ...
    return (
        <div
            className={cn(
                'shadow-input w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black',
                className,
            )}
        >
            ...
            <form className="my-8" onSubmit={handleSubmit}>
                <LabelInputContainer className="mb-6">
                    ...
                    <Input id="firstname" placeholder="Username, email or mobile number" type="text" />
                </LabelInputContainer>
